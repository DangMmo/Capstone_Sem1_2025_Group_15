...
FILE_PATH = "C:\\Users\\Dang\\Documents\\Capstone\\Sự vùng vẫy của Mmo 5\\Generated_Instance_UTM2C.csv"
...
# ==============================================================================
K_CLUSTERS_RANGE = range(2, 5) 
MAX_SCHEDULING_FLEXIBILITY = 960.0
